  ...
  return (
    <>
      ...
      <div className="mt-4 w-full py-6 px-4 shadow-details rounded-xl flex flex-col sm-min-h ">
        <div className="flex sm:flex-row flex-col w-full items-center gap-1 sm:gap-2 md:gap-1 lg:gap-2 max-w-3xl mx-auto">
...
const FirstStep = () => {
  return (
    <>
      ...
      <select className="w-full bg-transparent border border-[#E1E1E6] placeholder-[#8D8D99] rounded-md px-4 py-2.5 outline-none focus:ring-0 focus:outline-none">
