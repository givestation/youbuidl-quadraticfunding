    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill="#00A4FF"
            d="M24 2.308c-.9.461-1.8.615-2.85.769 1.05-.615 1.8-1.539 2.1-2.77-.9.616-1.95.924-3.15 1.231C19.2.615 17.85 0 16.5 0c-3.15 0-5.55 3.077-4.8 6.154C7.65 6 4.05 4 1.5.924.15 3.23.9 6.153 3 7.691c-.75 0-1.5-.307-2.25-.615 0 2.308 1.65 4.462 3.9 5.077-.75.154-1.5.307-2.25.154.6 2 2.4 3.538 4.65 3.538C5.25 17.231 2.55 18 0 17.692 2.25 19.077 4.8 20 7.5 20c9.15 0 14.25-7.846 13.95-15.077A7.023 7.023 0 0 0 24 2.308Z"
          />
        </svg>
      ),
    },
