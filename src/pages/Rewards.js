...
const Rewards = () => {
  ...
  const contributors = [
    {
      id: "0x7A419820688f895973825D3cCE2f836e78Be1eF4",
      totalContribution: 10000,
      referralNumber: 100,
      totalBuidlPointRewards: 200    
    },
    {
      id: "0x7A419820688f895973825D3cCE2f836e78Be1eF4",
      totalContribution: 10000,
      ...
      <div class='flex items-center justify-center space-x-4'>
        <div class='break-inside relative overflow-hidden flex flex-col justify-between space-y-2 text-sm rounded-xl max-w-[23rem] p-4 mb-4 bg-Chinese-Blue text-Pure-White h-[170px]'>
          ...
          <div class='flex flex-row items-center space-x-3'>
            ...
            <span class='text-base font-medium'>You have received 1000 points for funding 10 projects</span>
          </div>
        ...
        <div className='break-inside relative overflow-hidden flex flex-col justify-between space-y-2 text-sm rounded-xl max-w-[23rem] p-4 mb-4 bg-Chinese-Blue text-Pure-White h-[170px]'>
          ...
          <div class='flex flex-row items-center space-x-3'>
            ...
            <span class='text-base font-medium'>You have received 100 USDT for funding 100 projects</span>
          </div>
          <div class='flex justify-between items-center'>
            <span>50</span>
            <button className='flex items-center justify-center text-xs rounded-full px-4 py-2 space-x-1'>
              Claim
            </button>
          </div>
        </div>
        <div class='break-inside relative overflow-hidden flex flex-col justify-between space-y-2 text-sm rounded-xl max-w-[23rem] p-4 mb-4 bg-Chinese-Blue text-Pure-White h-[170px]'>
          ...
          <div class='flex flex-row items-center space-x-3'>
            ...
            <span class='text-base font-medium'>You have been referred on 50 contributions.<br />You get 10% of the referee's reward</span>
          </div>
          <div class='flex justify-between items-center'>
            <span>10</span>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
              ...
              {contributors.map((contributor, index) => (
                <tr class="hover:bg-gray-100 dark:hover:bg-gray-800">
                  ...
                  <td class="px-6 py-4">
                    <button class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">{contributor.totalBuidlPointRewards}</button>
                  </td>
                </tr>
              ))}
            </tbody>
