    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="grid xl:grid-cols-3 gap-4">
        <div className="w-full relative rounded-2xl xl:rounded-3xl bg-gradient-to-r from-cyan-700 to-blue-500  py-1.5 px-2 md:p-4 xl:px-6 xl:py-4 flex items-center flex-col xl:flex-row xl:space-x-4">
          ...
          <div className="hidden xl:block   z-10"></div>
        </div>
              ...
              <a href="#">
                <div class="relative flex items-end overflow-hidden rounded-xl">
                  ...
                  <div class="absolute bottom-3 left-3 inline-flex items-center rounded-lg bg-white p-2 shadow-md">
                    <div
                      ...
                      style={{ background: "#5AC5FF" }}
                    >
                      <div>
                        <img src={chainLogos[qfRound.chainId]} alt="" />
                      </div>
                ...
                <div class="mt-1 p-2">
                  ...
                  <div class="mt-3 flex items-end justify-between">
                    <p>
                      <div
                        className="font-normal text-lg flex items-center text-xs w-fit rounded-xl p-2 gap-0.5"
                        style={{ background: "#C7FF7A" }}
                      >
                        <div>
                          <img src={chainLogos[qfRound.chainId]} alt="" />
                        </div>
                    ...
                    <div class="mt-3 flex items-end justify-between">
                      ...
                      >
                        ...
                        <div style={{ color: "#818283" }}>
                          {qfRound.leftDays > 1
                            ? qfRound.leftDays + " more days to go"
                            : qfRound.leftHours + " more hours to go"}
                        </div>
                      </div>
                    </div>
                  </div>
